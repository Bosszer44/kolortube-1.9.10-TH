...
$max_num_pages = (int) ceil( $number_of_series / $posts_per_page );
    ...
    'hitodzuma-hanazono-gekijou',
    'tameike-goro',
    'nampa-japan',
    's-1-number-one-style',
    'jet-eizou',
    'million',
    'hon-naka',
    'goddess',
    ...
    'idea-pocket'
        ...
        if ( in_array( $term->slug, $blocked ) || in_array( $term->name, $blocked ) ) {
            continue;
        }
            ...
            'tax_query'      => array(
                array(
                    ...
                    'terms'    => $term->slug,
										...
										<?php
										echo function_exists( 'wps_term_image_img_html' ) ? wps_term_image_img_html( $term, 'actors', 'video-thumb' ) : '';
										?>
												</a>
